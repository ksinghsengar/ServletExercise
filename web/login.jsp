...
<div class="col-md-2 login" style="display:none;">
    ...
    <form method="post" action="Login">
        <div class="form-group">
            <input type="text" name="user" placeholder="Username" class="col-md-12 " required>
        </div>
        <div class="form-group">
            <input type="password" name="password" placeholder="Password" class="col-md-12" required>
        </div>
...
<div class="col-md-2 register" style="display:none;">
    ...
    <form method="post" action="Register" id="registeration">
        ...
        <div class="form-group">
            <input type="email" name="email" placeholder="Email" class="col-md-12" required>
        </div>
        <div class="form-group">
            <input type="password" name="regPassword" placeholder="Password" class="col-md-12" required>
        </div>
        <div class="form-group">
            <input type="password" name="confirmPassword" placeholder="Confirm Password" class="col-md-12" required>
        </div>
